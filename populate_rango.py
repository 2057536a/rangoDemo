...
def populate():
	...
	cats = [
        {'name': 'Python','views': 128,'likes': 64,'pages': python_pages},
        {'name': 'Django','views': 64,'likes': 32,'pages': django_pages},
        {'name': 'Other Frameworks','views': 32,'likes': 16,'pages': other_pages}
    ]
