...
def register(request):
	...
	if request.method == 'POST':
		...
		if user_form.is_valid() and profile_form.is_valid():
			...
			# Now we sdave the UserProfile model instance.
			profile.save()
			...
			# Print problems tot he terminal
...
def user_login(request):
	...
	if request.method == 'POST':
		# Gather the username and password by the user.
		# This information is obtained from the login form.
		# We use reqiest.POST.get('<variable>') as opposed
